...
export const { useLoginUserMutation, useGetUserProfileQuery, useGetAdminsQuery , useCreateUserMutation, useUpdateUserMutation, useDeleteUserMutation, useGetActivityLogsQuery} = apiService;
